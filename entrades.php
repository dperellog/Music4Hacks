...
<div class="main-content col-md-8 col-lg-9 col-xl-10 p-4">
    <div class="row text-center mb-4">
        ...
        <?= isset($errors['newEntSuccess']) ? '<p class="alert alert-success row">Entrada creada exitosament!</p>' : null ?>
        <?= isset($errors['newEntFailed']) ? '<p class="alert alert-danger row">' . $errors['newEntFailed'] . '</p>' : null ?>
    ...
    <div class="row">
        <div class="col-sm-8 content-box">
            ...
            <form action="functional/newentry.php" method="post" class="content">
                <div class="mb-2">
                    <label for="entry-name" class="form-label">Nom de l'entrada:</label>
                    <input type="text" name="entryName" class="form-control">
                ...
                <input type="submit" name="newEntry" value="Crear entrada" class="btn btn-primary">
            </form>
        </div>
